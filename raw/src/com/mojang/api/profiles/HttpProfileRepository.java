...
public class HttpProfileRepository implements ProfileRepository {
    ...
    public Profile[] findProfilesByNames(String... names) {
        ...
        try {
            ...
            int start = 0;
            int i = 0;
            System.err.println("    Will convert " + names.length + " names in batches of (at most) " + PROFILES_PER_REQUEST + ".");
            do {
                ...
                System.err.print("    Converting names [" + start + "," + String.valueOf(end-1) + "] ... ");
                ...
                System.err.println("took: " + (t1-t0)*(1e-3) + " seconds");
